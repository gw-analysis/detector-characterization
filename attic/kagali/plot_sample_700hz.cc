void plot_sample_700hz(){
  ...
  c1->cd(1);
  nt->SetMarkerColor(1);
  nt->Draw("A:(t1+t2)/2>>htmp(20,0.0,10.0,20,0,1.0)","f>670 && f<720","");
  ...
  nt->SetMarkerColor(2);
  nt->Draw("A:(t1+t2)/2","f>650 && f<750","same");
  
  c1->cd(2); 
  nt->SetMarkerColor(1);
  nt->Draw("f:(t1+t2)/2>>htmp(20,0,10.0,20,670,720)","","");
  ...
  nt->SetMarkerColor(2);
  nt->Draw("f:(t1+t2)/2","f>650 && f<750","same");

...
import DetectorNoiseGeneratorNoiseMon
...
--         psdmedian  =  gwpsd dat nfft sf :: [(Double, Double)]
     simdat <- psd2ts psdmedian 

     let psdoneshot =  gwpsdOneshot downdat nfft downsf :: [(Double, Double)]
	 ...
	 datzip = zip [8,16..] simdat
--     mapM_ printshow $ take maxf psdmedian
